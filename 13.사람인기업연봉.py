...
for company, average, minimum, maximum in zip(company_names, avg_values, min_salary, max_salary):
    salary_list.append([company, average, minimum, maximum])
...
df_salary = pd.DataFrame(salary_list, columns=['company', 'average', 'maximum', 'minimum'])

df_salary.to_csv('company_salary.csv', index=False, encoding='utf-8-sig')